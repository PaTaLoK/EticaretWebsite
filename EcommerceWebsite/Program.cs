...
builder.Services.AddAuthentication(x => {
    ...
    var Key = Encoding.UTF8.GetBytes("JAS(DJA()+^)(%/^()JKL3421242343kl4j234(U)+Û849dgfgre");
    o.SaveToken = true;
...
builder.Services.AddDbContext<RepositoryContext>(opts => opts.UseSqlServer("Data Source=DESKTOP-0PFALRP; Initial Catalog=EticaretDb; Integrated Security=True; TrustServerCertificate=True;")); // DB Connection
